...
#print str(facility_dict['Facility : # 88 USA'])
print ""
print str(facility_dict['Facility : # 88 USA'].keys())
print len(str(facility_dict['Facility : # 88 USA']['Max Use']))
print len(str(facility_dict['Facility : # 88 USA']['Trade Designation']))
print len(str(facility_dict['Facility : # 88 USA']['Product Function']))
print len(str(facility_dict['Facility : # 88 USA']['Company']))
